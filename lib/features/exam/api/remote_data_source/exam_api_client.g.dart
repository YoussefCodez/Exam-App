...
class _ExamApiClient implements ExamApiClient {
  ...
  Future<QuestionsExamModel> getQuestions(String id) async {
    ...
    late QuestionsExamModel _value;
    try {
      _value = QuestionsExamModel.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<ExamsResponseModel> getExams(String subjectId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'subject': subjectId};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ExamsResponseModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/v1/exams',
