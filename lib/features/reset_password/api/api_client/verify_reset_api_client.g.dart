...
part of 'verify_reset_api_client.dart';
...
class _VerifyResetApiClient implements VerifyResetApiClient {
  _VerifyResetApiClient(this._dio, {this.baseUrl, this.errorLogger});
