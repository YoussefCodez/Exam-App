...
part of 'new_password_api_client.dart';
...
class _NewPasswordApiClient implements NewPasswordApiClient {
  _NewPasswordApiClient(this._dio, {this.baseUrl, this.errorLogger});
